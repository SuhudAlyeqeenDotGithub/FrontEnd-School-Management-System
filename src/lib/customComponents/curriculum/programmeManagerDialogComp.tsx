        ...
        <div className="flex flex-col gap-3 border border-borderColor p-4 rounded-md shadow-md bg-backgroundColor-2">
          ...
          <div className="grid grid-cols-2 gap-3 w-full">
            ...
            <SearchableDropDownInput
              ...
              data={staffContracts}
              displayKeys={["_id", "staffId", "staffCustomId", "staffFullName"]}
              onSelected={(selectedData, save) => {
                if (save) {
                  setLocalData((prev: any) => ({
                    ...prev,
                    programmeManagerCustomStaffId: selectedData[2],
                    programmeManagerStaffId: selectedData[1],
                    programmeManagerFullName: selectedData[3]
                  }));
                  setUnsaved(true);
                }
              }}
