...
import { ChevronRight, ChevronLeft, HelpCircle, Trash2, Pencil, Eye, SquarePen, X } from "lucide-react";
...
export const CustomModal = ({
  ...
  const sizeClass = size === "large" ? "max-w-3xl" : "max-w-2xl";

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={onClose}>
      <div
        className={`bg-white rounded-xl shadow-2xl ${sizeClass} w-full max-h-[90vh] overflow-hidden flex flex-col`}
