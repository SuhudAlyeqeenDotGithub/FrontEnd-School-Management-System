...
export const ResponsibilityDialog = ({
  ...
  const [localData, setLocalData] = useState({
    ...
    responsibility: onCreateMode ? "" : data ? data.responsibility : "",
    description: onCreateMode ? "" : data ? data.description : ""
  });
    ...
    <div className="flex justify-center items-center absolute bg-foregroundColor-transparent inset-0">
      <ContainerComponent style="w-[55%] h-[55%] gap-10 flex flex-col z-40 bg-backgroundColor overflow-auto">
        ...
        <div className="flex justify-between items-center">
          <h2>{onCreateMode ? "New" : onEditMode ? "Edit" : "View"} Responsibility</h2>
