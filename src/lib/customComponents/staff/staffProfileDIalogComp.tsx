...
const StaffProfileDialogComponent = ({
  ...
  const onCreateMockData = {
    staffCustomId: generateCustomId(`STF`, true, "numeric"),
    staffFullName: `fullName ${generateCustomId(``, true, "numeric")}`,
    staffDateOfBirth: `2022-01-01`,
    staffGender: "Female",
    staffPhone: "+447843262033",
    staffEmail: `${generateCustomId(``, true, "numeric")}@email.com`,
    staffAddress: "ddd",
    staffPostCode: "ddd",
    staffImageUrl: "",
    imageLocalDestination: "",
    staffMaritalStatus: "ddd",
    staffStartDate: `2022-01-01`,
    staffEndDate: `2022-01-01`,
    staffNationality: "Africana",
    staffAllergies: "sss",
    staffNextOfKinName: "sss",
    staffNextOfKinRelationship: "sss",
    staffNextOfKinPhone: "sss",
    staffNextOfKinEmail: "sss",
    staffNextOfKinAddress: "sss",
    staffNextOfKinPostCode: "sss",
    skills: [],
    staffQualification: [],
    workExperience: [],
    identification: []
