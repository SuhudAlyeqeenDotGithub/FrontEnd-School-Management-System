...
export const tanFetchStaffProfiles = async (accountData: any, permittedActions: string[], action: string) => {
  if (!accountData) {
  ...
  const res = await handleApiRequest("get", `alyeqeenschoolapp/api/staff/profiles`);
